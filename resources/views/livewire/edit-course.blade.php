{{-- This component uses the *exact same* modal component --}}
<x-livewire.modal-form title="Edit Course" submit-action="updateCourse" submit-button-text="Update">
    
    {{-- 1. Category Selector --}}
    <div class="mb-4">
        {{-- The :initialId prop will be filled by $category_id from the component --}}
    ...
    <div class="mb-4">
        ...
        {{-- Use a unique ID to avoid conflicts if both modals are in the DOM --}}
    ...
    @if ($type === 'physical')
        <div class="mb-4" wire:ignore> 
            {{-- The :initialId prop will be filled by $center_id --}}
